...
class DateConverter {
  ...
  static String localDateFromDateToIsoString(DateTime? dateTime) {
    ...
    return DateFormat('dd MMM hh aa',  'en').format(dateTime);
  }
  ...
  static String localDateFromToIsoString(String? dateTime) {
    ...
    return DateFormat('dd MMM hh aa',  'en').format(isoStringToLocalDate(dateTime));
  }
  ...
  static  String convertiEnDateEtHeure(n) {
    DateTime startDateToDateTime = DateTime.fromMillisecondsSinceEpoch(n);
    print(startDateToDateTime); // 2023-11-06 15:28:24.305

// format the output year -  month -  day
    final DateFormat formatter = DateFormat('yyyy-MM-dd');
    final String startDateToDateTimeFormatted = formatter.format(startDateToDateTime);


    return startDateToDateTimeFormatted;
  }
}
